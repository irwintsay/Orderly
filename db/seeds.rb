...
User.create({name: 'Anna', username: 'anna', password: 'password'})
User.create({name: 'Blake', username: 'blake', password: 'password'})
User.create({name: 'Brendan', username: 'brendan', password: 'password'})
User.create({name: 'Michelle', username: 'michelle', password: 'password'})
User.create({name: 'Irwin', username: 'irwin', password: 'password'})

Table.create({server: User.all.sample})
Table.create({server: User.all.sample})
Table.create({server: User.all.sample})
Table.create({server: User.all.sample})
Table.create({server: User.all.sample})
